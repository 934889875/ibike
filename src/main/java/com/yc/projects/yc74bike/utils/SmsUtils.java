package com.yc.projects.yc74bike.utils;
...
public class SmsUtils {
	...
	/**
	 * 
	 * @param valcode: 待发送的验证码
	 * @param phoneNumbers: 待接收的电话号码
	 * @return
	 */
	public static String sendSms(String valcode, String[] phoneNumbers) {
		try {
			 ...
			 * 你也可以直接在代码中写死密钥对，但是小心不要将代码复制、上传或者分享给他人， 以免泄露密钥对危及你的财产安全。 CAM密匙查询:
			 * https://console.cloud.tencent.com/cam/capi
			 */
			// Credential cred = new Credential("secretId", "secretKey");
			Credential cred = new Credential(YcConstants.SMSSECREID, YcConstants.SMSSECREKEY);
			 ...
			 * 你可以通过官网接口文档或跳转到request对象的定义处查看请求参数的定义 基本类型的设置: 帮助链接： 短信控制台:
			 * https://console.cloud.tencent.com/sms/smslist sms helper:
			 * https://cloud.tencent.com/document/product/382/3773
			 */

			/* 短信应用ID: 短信SdkAppid在 [短信控制台] 添加应用后生成的实际SdkAppid，示例如1400006666 */
			req.setSmsSdkAppid(YcConstants.SMSSDKAPPID);

			/* 短信签名内容: 使用 UTF-8 编码，必须填写已审核通过的签名，签名信息可登录 [短信控制台] 查看 */
			req.setSign(YcConstants.SMSSIGN);
			...
			req.setTemplateID(YcConstants.SMSTEMPLATEID);
