package com.yc.projects.yc74bike.conf;
...
public class AppConfig {
    ...
    public MongoClient client() {
    	...
    	// mongos   路由服务器. 
    	ServerAddress sa1=new ServerAddress("192.168.14.200",23000);
    	ServerAddress sa2=new ServerAddress("192.168.14.201",23000);
    	ServerAddress sa3=new ServerAddress("192.168.14.202",23000);
    	list.add( sa1 );
    	list.add( sa2 );
    	list.add( sa3 );
	...
	public DriverManagerDataSource dataSource() {
		...
		dataSource.setUrl("jdbc:mysql://localhost:3306/sharebike");
